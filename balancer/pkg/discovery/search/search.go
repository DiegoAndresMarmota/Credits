...
func (re *Registry) Instance(ctx context.Context, instanceID string, serviceName string, hostPort string) error {
...
// NotInstance elimina un servicio del registro.
func (re *Registry) NotInstance(ctx context.Context, instanceID string, serviceName string) error {
...
func (re *Registry) ReportHealthyState(InstanceID string, _ string) error {
